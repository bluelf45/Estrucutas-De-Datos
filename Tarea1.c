...
int main(){
  int n,i,n2;
  printf("Maximo cantidad de palabras: ");scanf("%d",&n);
  printf("Maximo cantidad de prefijos: ");scanf("%d",&n2);
  char archivo1[21],archivo2[21];
  char palabras[n][201];
  char prefijos[n2][201];
  char palabra[201];
  printf("Nombre del archivo con palabras: ");scanf("%s",archivo1);
  printf("Nombre del archivo con prefijos: ");scanf("%s",archivo2);
